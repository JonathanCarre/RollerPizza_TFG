...
// Importaciones relacionadas con Firebase
import com.example.rollerpizza_tfg.MainActivity_IniciarSesion;
import com.example.rollerpizza_tfg.R;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button_crear_cuenta.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String text_confirm_password = TextInputRegisterConfirmPassword.getEditText().getText().toString();
                    ...
                    referencias_profile.child(firebaseUser.getUid()).setValue(writeUserDetails).addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            if (task.isSuccessful()){
                                ...
                                //Intent intent = new Intent(MainActivity_Pantalla_registrarse.this, MainActivity.class);
